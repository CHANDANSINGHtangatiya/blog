...
if(isset($_POST['submit'])){
    ...
    if(isset($_POST['heading'])){
        ...
        if(isset($_POST['latest'])){
         ...
         $query="INSERT INTO securitys (image,heading,author,Rdate,containt,popular,latest) VALUES ('$file_name', '$heading', '$author', '$date','$containt', '$popular', '$latest')";
...
?>
   ...
   <div class="main h-full w-[80%] bg-zinc-200 flex items-center justify-center">
    <form action="security.php" method="post" class=" bg-zinc-400 p-9 rounded-lg" enctype="multipart/form-data" >
<h1 class="text-3xl font-bold mb-9 ml-[10vw] text-pink-900">security Blogs</h1>
