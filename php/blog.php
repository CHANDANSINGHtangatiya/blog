...
if(isset($_POST['submit'])){
    ...
    if(isset($_POST['heading'])){
        ...
        if(isset($_POST['latest'])){
         ...
         $query="INSERT INTO blogs (image,heading,author,Rdate,containt,popular,latest) VALUES ('$file_name', '$heading', '$author', '$date','$containt', '$popular', '$latest')";
...
?>
    ...
    <form action="blog.php" method="post" class=" bg-zinc-400 p-9 rounded-lg" enctype="multipart/form-data" >
<h1 class="text-3xl font-bold mb-9 ml-[10vw] text-pink-900">Blogs</h1>
